...
<tileset version="1.10" tiledversion="1.10.2" name="temp_tileset" tilewidth="32" tileheight="32" tilecount="88" columns="8">
 <image source="temp_tileset.png" trans="ff00ff" width="256" height="352"/>
 <tile id="1">
  <animation>
